#!/usr/bin/env sh
# Universal installer for warmline. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/warmline.git"
echo "Installing warmline ..."
